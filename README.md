...
게임이라는 장르를 선택하게 되었다. 그 중에 오파고는 AI기반으로 인한 조금 색다른 게임으로 접근을 할 수 있어 흥미를<br/>
가질 수 있었다. 해당 게임이라는 장르를 접해 오픈소스를 가져오면서 추가로 구현하고자 했던 기능들은 랭킹시스템,<br/>
승패 화면 전환 기능, 버튼 추가로 매끄러운 게임 진행을 이루고자 했으며, DB를 기반으로 한 랭킹시스템을 연동을 시켜<br/>
도전 의식을 불러일으키려고 했다. <br/>
　또한 오픈소스를 해석함에 있어 가중치라는 부분을 확인하기 위해 디버깅이나, 가중치 표출 코딩등을 시도하기도 했었다.<br/>
하지만 한정적인 프로젝트 진행 시간 및 생각보다 높은 수준의 오픈소스 코딩의 난이도로 인해 원하는 목표치에 도달하지<br/>
못하여 아쉬웠으며 프로젝트를 진행하면서 기존보다 전체적인 코딩 및 프로그래밍에 대한 이해도가 높아졌다.<br/>
　그리고 코딩에 대해 프로젝트를 하며 역할분배나 문제를 인식하여 팀활동에 대한 경험치를 쌓을 수 있었다. 다소 어려운 <br/>
문제와 익숙치 않은 프로젝트라는 과제 형식에 다소 난관이 있었으나 각자의 노력으로 잘해결해 나갈 수 있었던 것 같다.<br/>
어려운 오픈소스 코드를 해석함에 있어 다같이 머리를 맞대어 가설을 세우고 그 가설이 참으로 증명 될때의 희열과 성취<br/>
감을 느낄 수 있었다. 이렇듯 프로젝트라는 과제를 수행함에 있어 최초의 세운 목표에는 못미쳤지만 혼자라면 하지 못했<br/>
을 문제들을 함께여서 해결 할 수 있었던 것 같다.<br/>
